	...
	public static void main(String[] args) throws Exception {
		...
		for(int i = 1; i <= 10 ; i++) {
			Heading = driver.findElement(By
					.xpath("/html/body/div[3]/div[2]/div[1]/div[4]/div/div[" + i + "]/div[2]/h3/a"));
			Answer = driver.findElement(By
					.xpath("/html/body/div[3]/div[2]/div[1]/div[4]/div/div[" + i + "]/div[2]/div[1]"));
			Views = driver.findElement(By
					.xpath("/html/body/div[3]/div[2]/div[1]/div[4]/div/div[" + i + "]/div[1]/div[3]/span[1]"));
			Votes = driver.findElement(By
					.xpath("/html/body/div[3]/div[2]/div[1]/div[4]/div/div[" + i + "]/div[1]/div[1]/span[1]"));
		...
		writernew.close();
		System.out.println("File writen to the data.csv file successfully");
